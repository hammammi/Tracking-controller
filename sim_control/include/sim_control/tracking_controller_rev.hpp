...
class tracking_controller{
    ...
    void cmd_vel_pub(){
       ...
       if(fabs(x_goal-x_robot)>0.10 && fabs(y_goal-y_robot)>0.10){
       ...
       if(control_enable){
           ...
           try{
            ...
            ROS_INFO("x_robot : %lf y_robot : %lf",x_robot,y_robot);
           ...
           vphi_cmd_robot = 0.5*K_p[2] * phi_err;

           ROS_INFO("phi_goal : %lf",phi_goal);
